...
## безопастная чистка данных профиля стим
...
При первом запуске у вас ее не будет.
Используя шаг 2 и шаг 3, будет создан файл `Settings.json`. там хранится путь к сохранению папки `userdata` после переноса.
